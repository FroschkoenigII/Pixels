...
public class Test extends Thread {
	...
	private int scale = 1;
	private int i = 0;
	private GraphicsConfiguration config = GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice()
	...
	public void updateGame() {
		...
		graphics.drawLine(100, 200, 300, i % 400);
		i++;
	...
	public void renderGame(Graphics2D g) {
		...
		g.fillRect(22, 230, width, height);
	}
